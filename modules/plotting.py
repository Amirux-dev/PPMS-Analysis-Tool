...
def create_plot_interface(plot_id: str, available_datasets: List[Dict[str, Any]], width: int, height: int) -> Optional[go.Figure]:
    """Creates a self-contained plotting interface and returns the figure. Optimized for performance."""
            ...
            if show_linear_fit:
                with st.expander("Linear Fit Configuration", expanded=True):
                    ...
                    for fid in selected_fit_ids:
                        ...
                        linear_fit_settings[fid] = {"color": f_color, "style": f_style, "width": f_width}
            ...
            if show_parabolic_fit:
                with st.expander("Parabolic Fit Configuration", expanded=True):
                    ...
                    for fid in selected_pfit_ids:
                        ...
                        parabolic_fit_settings[fid] = {"color": pf_color, "style": pf_style, "width": pf_width}
    ...
    st.plotly_chart(fig, use_container_width=True, key=f"chart_{plot_id}", on_select="rerun", selection_mode="points")
